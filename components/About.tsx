...
export default function About() {
  ...
  return (
    <section id="about" className="relative py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-purple-50 via-white to-indigo-50 overflow-hidden">
          ...
          <div className="grid lg:grid-cols-5 gap-12 items-start mb-12">
            ...
            <motion.div variants={itemVariants} className="lg:col-span-3 space-y-6">
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                ...
                <span className="font-semibold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">6+ years of experience</span>{' '}
              ...
              <div className="flex flex-wrap gap-4 pt-4">
                ...
                <div className="flex items-center gap-2 text-gray-700">
                  ...
                  <a href="mailto:karanscy@gmail.com" className="hover:text-purple-700 transition-colors">
                    karanscy@gmail.com
                  </a>
                </div>
                <div className="flex items-center gap-2 text-gray-700">
